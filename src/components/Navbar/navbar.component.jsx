...
const NavLg = () => {
    return <>
       ...
       placeholder="Search for Movies,events,Plays,Sports and Activities" />
           ...
           <span className="text-gray-200 text-xs flex items-center cursor-pointer hover:text-white">Bengaluru <BiChevronDown /> </span>
           <button className="bg-button-300 text-white px-2 py-1 text-sm rounded">Sign in</button>
...
const Navbar = () => {
    return (
       ...
       <nav className="bg-bms-700 p-4">
              ...
              <div className="hidden md:flex lg:hidden">{/*Tablet devices*/ }
